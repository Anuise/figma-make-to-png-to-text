...
const validStatuses: WorkflowDraftReviewStatus[] = ["confirmed", "excluded", "pending"];
...
export async function POST(
  ...
  try {
    const drafts = await batchUpdateWorkflowDraftReview(
      getPool(),
      id,
      ids as string[],
      reviewStatus as WorkflowDraftReviewStatus,
    );
